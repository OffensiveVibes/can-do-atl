...
function App() { return <ErrorBoundary><ThemeProvider defaultTheme="light"><TooltipProvider><Toaster /><StaffSignInEntry /><Router /></TooltipProvider></ThemeProvider></ErrorBoundary>; }
export default App;
