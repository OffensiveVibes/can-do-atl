...
export default function About() {
  ...
  return <div className="about-page"><header className="about-header"><a className="brand-lockup" href="/" aria-label="Can Do ATL home"><span className="brand-mark-wrap"><img src="/manus-storage/cando-mark_4f760226.png" alt="" className="brand-mark" /></span><span className="brand-name"><strong>Can Do</strong><em>ATL</em></span></a><nav aria-label="About Us navigation"><a href="/">Home</a><a href="#team">Our team</a></nav><a className="about-staff-link" href="/admin"><Smile size={16} /> Staff sign in</a></header><main><section className="about-hero"><div className="about-hero-tape" aria-hidden="true" /><p className="kicker">About Can Do ATL</p><h1>We make room for each other.</h1><p>Can Do ATL is a student-led, multi-campus organization building practical paths to food and clothing access across Georgia Tech, Georgia State, and Kennesaw State.</p><div className="about-campus-line"><span>Georgia Tech</span><i /><span>Georgia State</span><i /><span>Kennesaw State</span></div></section><section id="team" className="about-team-section"><div className="about-section-intro"><div><p className="kicker">The people behind the work</p><h2>Our team, in their own words.</h2></div><p>Click a profile to learn more and find each person’s linked social spaces. Team profiles are managed directly from the private staff workspace.</p></div>{content.isLoading ? <div className="about-loading">Loading the team board…</div> : <div className="about-profile-grid">{members.map((member, index) => <ProfileCard key={member.id ?? member.position} member={member} index={index} />)}</div>}</section><section className="about-join-note"><div><UsersRound size={25} /><p className="kicker">Want to join the work?</p><h2>There is room at this table.</h2><p>Bring your organizing skills, practical ideas, or an hour to help. Every contribution strengthens the campus trail.</p></div><a href="https://forms.gle/ZnfzPQnNQNVfWABXA" target="_blank" rel="noreferrer">Volunteer with us <ChevronDown size={18} /></a></section></main><footer className="about-footer"><span>© {new Date().getFullYear()} Can Do ATL</span><a href="/">Small supplies. Shared strength.</a><span>Atlanta, Georgia</span></footer></div>;
}
